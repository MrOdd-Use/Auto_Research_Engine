    ...
    <main className="flex flex-col min-h-screen bg-gray-900">
      ...
      <footer className="mt-auto py-3 px-4 text-center border-t border-gray-800/40 bg-gray-900/80 backdrop-blur-sm">
        <div className="flex items-center justify-center gap-5 mb-3">
          ...
          <a href="https://github.com/MrOdd-Use/Auto_Research_Engine" target="_blank" className="text-gray-400 hover:text-gray-300 transition-colors">
            <img
              src="/img/github.svg"
              alt="GitHub"
              width={20}
          ...
          <a href="https://hub.docker.com/r/gptresearcher/Auto_Research_Engine" target="_blank" className="text-gray-400 hover:text-gray-300 transition-colors">
            <img
              src="/img/docker.svg"
              alt="Docker"
              width={20}
