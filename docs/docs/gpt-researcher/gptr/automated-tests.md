...
This repository contains the code for the automated testing of the Auto_Research_Engine Repo using Github Actions. 
...
```bash
docker-compose --profile test run --rm Auto_Research_Engine-tests
```
