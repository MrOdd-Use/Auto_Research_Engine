...
Add `langchain-azure-dynamic-sessions` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain-ollama` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain-groq` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain-anthropic` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain-mistralai` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain-together` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
```
Add langchain-netmind to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or pip install it
...
Add `langchain-huggingface` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain-google-genai` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain-google-vertexai` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain-cohere` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain-fireworks` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain_aws` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain_community` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain_xai` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `dashscope` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
...
Add `langchain-voyageai` to [requirements.txt](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/requirements.txt) for Docker Support or `pip install` it
