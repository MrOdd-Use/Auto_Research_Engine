...
For debugging, have a look at the <a href="https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/frontend/nextjs/helpers/getHost.ts">getHost function.</a>