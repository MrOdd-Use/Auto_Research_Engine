...
```bash
Step 3: Pass your Langchain Vectorstore into your GPTR report ([more on that here](https://docs.gptr.dev/docs/Auto_Research_Engine/context/vector-stores) and below)
```
...
Below is a custom data ingestion process that you can use to ingest your data into a Langchain VectorStore. See a [full working example here](https://github.com/MrOdd-Use/Auto_Research_Engine/pull/819#issue-2501632831).
