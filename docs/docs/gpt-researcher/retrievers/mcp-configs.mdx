...
*For more examples and advanced use cases, check out the [GPT Researcher examples repository](https://github.com/MrOdd-Use/Auto_Research_Engine/tree/master/examples).* :-) 