...
This guide specifically focuses on how to integrate your locally running Auto_Research_Engine MCP server with the Claude desktop application for Mac, providing a seamless research experience within the Claude interface.
...
1. Auto_Research_Engine MCP server installed and running locally
...
### 1. Install and Run the Auto_Research_Engine MCP Server

Make sure you have the Auto_Research_Engine MCP server installed and running:
...
2. **Edit the Configuration File**:
   ...
   - Add or update the `mcpServers` section to include your local Auto_Research_Engine MCP server:
...
```json
{
  "mcpServers": {},
  "externalMCPServers": {
    "Auto_Research_Engine": "http://localhost:8000/mcp"
  }
}
```
...
- Clicking this icon should display the Auto_Research_Engine tools provided by your MCP server
- If you don't see the hammer icon, check the Claude application logs for any errors

## Using Auto_Research_Engine in Claude Desktop
...
- Learn about [additional configuration options](../gptr/config) for the Auto_Research_Engine
