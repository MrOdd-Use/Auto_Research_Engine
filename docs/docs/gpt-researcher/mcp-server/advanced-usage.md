...
This guide covers advanced usage scenarios and configurations for the Auto_Research_Engine MCP Server.
...
```bash
docker build -t Auto_Research_Engine-mcp .
docker run -p 8000:8000 -e OPENAI_API_KEY=your_key -e TAVILY_API_KEY=your_key Auto_Research_Engine-mcp
```
...
- Contribute to the [Auto_Research_Engine project](../../contribute)
