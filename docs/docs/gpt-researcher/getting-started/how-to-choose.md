...
Auto_Research_Engine is a powerful autonomous research agent designed to enhance and streamline your research processes. Whether you're a developer looking to integrate research capabilities into your project or an end-user seeking a comprehensive research solution, Auto_Research_Engine offers flexible options to meet your needs.

We envision a future where AI agents collaborate to complete complex tasks, with research being a critical step in the process. Auto_Research_Engine aims to be your go-to agent for any research task, regardless of complexity. It can be easily integrated into existing agent workflows, eliminating the need to create your own research agent from scratch.

## Options

Auto_Research_Engine offers multiple ways to leverage its capabilities:

<img src="https://github.com/user-attachments/assets/305fa3b9-60fa-42b6-a4b0-84740ab6c665" alt="Logo" width="568"></img>
<br></br>

1. **Auto_Research_Engine PIP agent**: Ideal for integrating Auto_Research_Engine into your existing projects and workflows.
...
The PIP package is ideal for leveraging Auto_Research_Engine as an agent in your preferred environment and code.
...
**Learn More:** [PIP Documentation](https://docs.gptr.dev/docs/Auto_Research_Engine/gptr/pip-package)
...
**Getting Started:**
1. Clone the repository: `git clone https://github.com/MrOdd-Use/Auto_Research_Engine.git`
2. Follow the [installation instructions](https://docs.gptr.dev/docs/Auto_Research_Engine/getting-started)
...
**Advanced Usage Example:** [Detailed Report Implementation](https://github.com/MrOdd-Use/Auto_Research_Engine/tree/master/backend/report_type/detailed_report)

### 3. Multi Agent System with LangGraph

We've collaborated with LangChain to support multi-agents with LangGraph and Auto_Research_Engine, offering the most complex and comprehensive version of Auto_Research_Engine.
...
**Learn More:** [Auto_Research_Engine x LangGraph](https://docs.gptr.dev/docs/Auto_Research_Engine/multi_agents/langgraph)
...
1. **PIP Package**: 
   - Install: `pip install Auto_Research_Engine`
   - [Integration guide](https://docs.gptr.dev/docs/Auto_Research_Engine/gptr/pip-package)

2. **End-to-End Application**: 
   - Clone the repository: `git clone https://github.com/MrOdd-Use/Auto_Research_Engine.git`
   - [Installation instructions](https://docs.gptr.dev/docs/Auto_Research_Engine/getting-started)

3. **Multi-Agent System**: 
   - [Multi-Agents code](https://github.com/MrOdd-Use/Auto_Research_Engine/tree/master/multi_agents)
   - [LangGraph documentation](https://docs.gptr.dev/docs/Auto_Research_Engine/multi_agents/langgraph)
   - [Blog](https://docs.gptr.dev/blog/gptr-langgraph)

## Versioning and Updates

Auto_Research_Engine is actively maintained and updated. To ensure you're using the latest version:

- For the PIP package: `pip install --upgrade Auto_Research_Engine`
