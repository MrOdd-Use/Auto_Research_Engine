...
- An OpenAI API key (you can also choose other supported [LLMs](../Auto_Research_Engine/llms/llms.md))
- A Tavily API key (you can also choose other supported [Retrievers](../Auto_Research_Engine/search-engines/retrievers.md))
