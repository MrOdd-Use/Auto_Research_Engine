...
This is why we've built the trending open source **[GPT Researcher](https://github.com/MrOdd-Use/Auto_Research_Engine)**. GPT Researcher is an autonomous agent that takes care of the tedious task of research for you, by scraping, filtering and aggregating over 20+ web sources per a single research task. 
