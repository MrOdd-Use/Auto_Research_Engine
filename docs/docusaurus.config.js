...
module.exports = {
  ...
  trailingSlash: false,
  projectName: 'Auto_Research_Engine',
  themeConfig: {
    navbar: {
      title: 'Auto_Research_Engine',
      logo: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/MrOdd-Use/Auto_Research_Engine',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Auto_Research_Engine.`,
    },
  },
  presets: [
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/MrOdd-Use/Auto_Research_Engine/tree/master/docs',
          remarkPlugins: [math],
          rehypePlugins: [katex],
        },
        blog: {
