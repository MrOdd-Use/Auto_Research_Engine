...
[![Skill](https://img.shields.io/badge/Claude%20Skill-skills.sh-blueviolet?style=flat&logo=anthropic&logoColor=white)](https://skills.sh/MrOdd-Use/Auto_Research_Engine/Auto_Research_Engine)
...
**GPT Researcher is an open multi-agent research system designed for both web and local research on any given task.** 
...
Extend Claude's multi-agent research capabilities by installing GPT Researcher as a [Claude Skill](https://skills.sh/MrOdd-Use/Auto_Research_Engine/Auto_Research_Engine):

```bash
npx skills add MrOdd-Use/Auto_Research_Engine
```

Once installed, Claude can leverage GPT Researcher's multi-agent research capabilities directly within your conversations.
...
## Tutorials
 - [How it Works](https://docs.gptr.dev/blog/building-Auto_Research_Engine)
...
See the [Documentation](https://docs.gptr.dev/docs/Auto_Research_Engine/getting-started) for:
...
For other setups (e.g., Poetry or virtual environments), check the [Getting Started page](https://docs.gptr.dev/docs/Auto_Research_Engine/getting-started).
...
**For more examples and configurations, please refer to the [PIP documentation](https://docs.gptr.dev/docs/Auto_Research_Engine/gptr/pip-package) page.**
...
> For comprehensive MCP documentation and advanced examples, visit the [MCP Integration Guide](https://docs.gptr.dev/docs/Auto_Research_Engine/retrievers/mcp-configs).
...
[Learn more about Image Generation](https://docs.gptr.dev/docs/Auto_Research_Engine/gptr/image_generation) in our documentation.

## Run with Docker

> **Step 1** - [Install Docker](https://docs.gptr.dev/docs/Auto_Research_Engine/getting-started/getting-started-with-docker)
...
Step 2: 
 ...
 - If you're running GPT Researcher with the [PIP package](https://docs.tavily.com/guides/Auto_Research_Engine/Auto_Research_Engine#pip-package), pass the `report_source` argument as "local" when you instantiate the `GPTResearcher` class [code sample here](https://docs.gptr.dev/docs/Auto_Research_Engine/context/tailored-research).
...
The GPT Researcher MCP Server enables AI applications like Claude to conduct comprehensive multi-agent research. While LLM apps can access web search tools with MCP, GPT Researcher MCP delivers more reliable research results.

Features:
- Multi-agent research capabilities for AI assistants
...
Check it out [here](https://github.com/MrOdd-Use/Auto_Research_Engine/tree/master/multi_agents) or head over to our [documentation](https://docs.gptr.dev/docs/Auto_Research_Engine/multi_agents/langgraph) for more information.
...
1. Set the following environment variables:
   ...
   export LANGCHAIN_PROJECT="Auto_Research_Engine"
   ```
...
For detailed setup instructions and more information about the frontend features, please visit our [documentation page](https://docs.gptr.dev/docs/Auto_Research_Engine/frontend/introduction).

## 🚀 Contributing
We highly welcome contributions! Please check out [contributing](https://github.com/MrOdd-Use/Auto_Research_Engine/blob/master/CONTRIBUTING.md) if you're interested.

Please check out our [roadmap](https://trello.com/b/3O7KBePw/Auto_Research_Engine-roadmap) page and reach out to us via our [Discord community](https://discord.gg/QgZXvJAccX) if you're interested in joining our mission.
