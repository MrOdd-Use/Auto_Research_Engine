...
# Note: LLM client is now handled through Auto_Research_Engine's unified LLM system
...
class ChatAgentWithMemory:
    ...
    async def chat(self, messages, websocket=None):
        ...
        try:
            ...
            system_prompt = f"""
            You are Auto_Research_Engine, an autonomous research agent created by an open source community at https://github.com/MrOdd-Use/Auto_Research_Engine, homepage: https://gptr.dev. 
            To learn more about Auto_Research_Engine you can suggest to check out: https://docs.gptr.dev.
