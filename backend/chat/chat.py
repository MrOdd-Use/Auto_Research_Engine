...
class ChatAgentWithMemory:
    ...
    async def chat(self, messages, websocket=None):
        ...
        try:
            ...
            system_prompt = f"""
            You are GPT Researcher, an autonomous research agent created by an open source community at https://github.com/MrOdd-Use/Auto_Research_Engine, homepage: https://gptr.dev. 
