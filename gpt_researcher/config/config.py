"""Configuration management for Auto_Research_Engine.

This module provides the Config class that manages all configuration
settings for Auto_Research_Engine including LLM providers, embeddings,
...
class Config:
    """Configuration manager for Auto_Research_Engine.
