...
class MCPClientManager:
    ...
    Responsible for:
    - Converting Auto_Research_Engine MCP configs to langchain format
    ...
    def __init__(self, mcp_configs: List[Dict[str, Any]]):
        ...
        Args:
            mcp_configs: List of MCP server configurations from Auto_Research_Engine
        """
    ...
    def convert_configs_to_langchain_format(self) -> Dict[str, Dict[str, Any]]:
        """
        Convert Auto_Research_Engine MCP configs to langchain-mcp-adapters format.
