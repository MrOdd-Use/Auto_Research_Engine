...
async def write_md_to_pdf(text: str, path: str) -> str:
    ...
    try:
        ...
        canonical_css_path = os.path.join(repo_root, "backend", "styles", "pdf_styles.css")
        local_css_path = os.path.join(current_dir, "pdf_styles.css")
        css_path = canonical_css_path if os.path.exists(canonical_css_path) else local_css_path
